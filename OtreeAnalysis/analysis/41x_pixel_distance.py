...
Two clean plots for canvas distance vs edge polarity (no SE bars).
Companion to 41_pixel_distance.py.

Reads:
  public/distractors_w*.json

Writes ../fig/canvas_distance/:
  normdist_means.pdf        — means only, no raw points
  normdist_rawdots.pdf      — means + raw participant-level points
"""
